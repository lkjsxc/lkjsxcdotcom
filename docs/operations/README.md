...
- [cutover.md](cutover.md): green deployment and traffic switch.

Nothing in this directory claims a deployment exists until `current-state.md`
and recorded verification say so.
